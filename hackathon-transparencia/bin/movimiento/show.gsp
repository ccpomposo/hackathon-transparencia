...
<html>
    ...
    <body>
        ...
        <div id="show-movimiento" class="content scaffold-show" role="main">
            ...
            <f:display bean="movimiento" />
            <g:form resource="${this.movimiento}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.movimiento}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

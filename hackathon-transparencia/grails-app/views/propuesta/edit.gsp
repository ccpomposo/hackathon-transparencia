...
<html>
    ...
    <body>
        <a href="#edit-propuesta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-propuesta" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.propuesta}" method="PUT">
                <g:hiddenField name="version" value="${this.propuesta?.version}" />
                <fieldset class="form">
